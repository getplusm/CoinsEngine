...
import t.me.p1azmer.engine.coins.data.serialize.CurrencyDataSerializer;
...
import t.me.p1azmer.engine.api.data.sql.executor.SelectQueryExecutor;
...
public class DataHandler extends AbstractUserDataHandler<CoinsEngine, CoinsUser> {
    ...
    @NotNull
    public Map<t.me.p1azmer.engine.coins.api.currency.Currency, Map<String, Double>> getBalances() {
